    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-title">Request / s</li>

                <li class="sidebar-item ">
                    <a href="{{ route('account-request-page') }}" class="sidebar-link">
                ...
                <li class="sidebar-title">Event / s</li>

                <li class="sidebar-item ">
                    <a href="{{ route('event-schedule') }}" class="sidebar-link">
                ...
                <li class="sidebar-item ">
                    <a href="{{ route('event-list-page') }}" class="sidebar-link">
                ...
                <li class="sidebar-item ">
                    <a href="{{ route('event-photos') }}" class="sidebar-link">
