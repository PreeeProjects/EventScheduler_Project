        ...
        <tr>
            <td style="padding: 30px 20px; text-align: center;">
                ...
                <p style="color: #555; font-size: 16px; line-height: 1.6;">
                    We regret to inform you that your account request has been declined by the Administrator.
                </p>
                <p style="color: #555; font-size: 16px; line-height: 1.6;">
                    If you believe this was a mistake or would like to appeal the decision, please feel free to contact
                    our support team.
                </p>
